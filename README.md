...
Quick Start
bashgit clone https://github.com/ravindu-ranasinghe/geospatial-dashboard.git
...
Data Source
Crime incident data sourced from the Minneapolis Police Department Open Data Portal. The dataset includes reported incidents with coordinates, offense category, date, and neighborhood.
Tech Stack
ComponentTechnologyWhyLanguagePythonPandas + geospatial ecosystemDashboard UIStreamlitFast interactive dashboards with no frontend codeMap renderingFoliumLeaflet.js wrapper — interactive maps in pure PythonData processingPandasStandard for tabular data manipulation
Project Structure
